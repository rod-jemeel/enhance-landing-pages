...
export default function CustomerServiceSection() {
  ...
  return (
    <section
      ref={container}
      className="relative h-[90vh] bg-white overflow-hidden border-t border-[#F0E68C]/20 flex items-center"
    >
      <motion.div
            ...
            <div className="grid lg:grid-cols-5 items-stretch">
              <div className="lg:col-span-3 p-12 lg:p-16 flex flex-col justify-center">
                ...
                <blockquote className="text-xl lg:text-2xl text-[#333333] leading-relaxed mb-8 font-medium">
                  "Real progress in health and wellness comes when we treat the
                  whole person—not just the symptoms. By focusing on
                  personalized care and addressing the root causes of your
                  challenges, I can help you achieve sustainable results that
                  improve not just your body but your entire quality of life.
