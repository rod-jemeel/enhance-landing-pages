...
import { Facebook, Twitter, Youtube, Instagram, Shield, Lock, Phone, Mail, Clock } from 'lucide-react';
...
export default function Footer() {
  ...
  return (
    <footer ref={container} className="relative bg-[#1A1E29] text-white pt-24 pb-16 px-6 overflow-hidden border-t border-[#F0E68C]/20">
      <motion.div 
        style={{ y, opacity }}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3 text-[#E0E0E0]">
              <div className="flex items-center gap-2">
                ...
                <a href="tel:1-888-299-5088" className="hover:text-white transition-colors">1-888-299-5088</a>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="w-4 h-4" />
                <a href="mailto:support@enhance.md" className="hover:text-white transition-colors">support@enhance.md</a>
              </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-[#E0E0E0]">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Medication & Pricing</a></li>
              <li><a href="#" className="hover:text-white transition-colors">How it Works</a></li>
              <li><a href="#" className="hover:text-white transition-colors">FAQ</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Book a Consultation</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-[#E0E0E0]">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Notice to Consumers</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Florida Patients</a></li>
        ...
        <div className="border-t border-gray-800 pt-8">
          ...
          <div className="text-[#E0E0E0] text-xs space-y-2 max-w-4xl mx-auto">
            <p className="text-center">
              285 N. El Camino Real, STE 211, Encinitas, CA 92024 | 13280 Evening Creek Drive South, STE 225, San Diego, CA 92128
            </p>
            ...
            <p className="leading-relaxed">
              Enhance.MD LLC is a patient management platform that provides administrative and operational support to physicians and practitioners employed by Enhance Wellness PC and iThriveMD PC, who deliver care through a telehealth platform. Enhance.MD LLC does not provide medical or pharmacy services, employ healthcare providers, or influence clinical decision-making.
            </p>
          </div>
        </div>
      </motion.div>
