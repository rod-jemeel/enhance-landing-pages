          ...
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                >
                  Enhance Your
                  <span className="block bg-gradient-to-r from-[#F0E68C] via-[#FFD700] to-[#D4AF37] bg-clip-text text-transparent">
                    Weight Loss Journey
                  </span>
                </motion.h1>
                <motion.p
                ...
                >
                  Affordable weight loss starting at $212/mo. Provider
                  personalized dosages, one all-in price. It's that simple.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, y: 30 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <button
                    className="relative overflow-hidden px-8 py-3 rounded-full font-medium transition-all hover:scale-105 text-[#333333] shadow-lg hover:shadow-xl"
                    style={{
                      background:
